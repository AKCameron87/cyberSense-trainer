import{b as u}from"./chunk-5GH7QX5K.js";var p=class c{API_URL="http://localhost:3001/v1/messages";MODEL="claude-sonnet-4-20250514";async generatePhishingScenario(i,e=[]){let o=e.length?`Do NOT generate any of these scenarios: ${e.join(", ")}.`:"",n=`Generate a realistic phishing simulation scenario for a cybersecurity training app.
Difficulty: ${i}
${o}
